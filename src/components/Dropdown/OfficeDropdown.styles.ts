import {IOfficeDropdownStyleProps, IOfficeDropdownStyles} from "@/components/Dropdown/OfficeDropdown.types";
import {FontSizes, FontWeights, HighContrastSelector, normalize} from "@/styling";
import {getGlobalClassNames} from "@/styling/styles/getGlobalClassNames";
import {IRawStyle, IStyle, IStyleFunction} from "@uifabric/merge-styles";
...
export const getStyles: IStyleFunction<IOfficeDropdownStyleProps, IOfficeDropdownStyles> = (props) => {
