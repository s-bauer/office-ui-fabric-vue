...
<script lang="ts">
    ...
    export default class OfficeChoiceGroup extends Vue implements IOfficeChoiceGroupProps {
        // @formatter:off
        @Model("change", {type: [String, Number], default: null})   public selectedKey?: string | number;
        ...
        private get keyDefaultFocusable() {
            const firstEnabledOption = this.disabled || this.options === undefined
                ? undefined
