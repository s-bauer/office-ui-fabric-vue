...
import { getWindow } from "@s-bauer/uifabric-utilities";
import { isDirectionalKeyCode } from "@s-bauer/uifabric-utilities";
...
export default class OfficeFabric extends Vue implements IOfficeFabricProps {
  @Prop({ type: Boolean }) public styles?: IStyleFunctionOrObject<
    IOfficeFabricStyleProps,
    IOfficeFabricStyles
  >;
