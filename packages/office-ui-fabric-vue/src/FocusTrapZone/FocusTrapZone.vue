...
<script lang="ts">
    ...
    import {elementContains} from "@s-bauer/uifabric-utilities";
    import {focusAsync, getFirstTabbable, getLastTabbable, getNextElement} from "@s-bauer/uifabric-utilities";
