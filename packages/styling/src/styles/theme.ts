import {Customizations} from "@s-bauer/uifabric-utilities";
 ...
 */
function _expandFrom<TRetVal, TMapType>(propertyName: string | TRetVal | undefined, ...maps: TMapType[] | any): TRetVal {
    if (propertyName) {
